...
checkpoint_dir = "D:/test11111111111111/test11111111111111\checkpoint_dir"
...
def parse_args():
    ...
    parser.add_argument('--dataset', type=str, default='cifar10', choices=['cifar10', 'fashion-mnist', 'celebA','cifar10'], help='The name of dataset')#add cifar10
